...
local Patcher =
    loadstring(game:HttpGet(MainLink .. 'TDSTools/ConvertFunc.lua', true))() --loadstring(game:HttpGet("https://raw.githubusercontent.com/Memeboiyot/tds/main/ConvertFunc.lua", true))()
